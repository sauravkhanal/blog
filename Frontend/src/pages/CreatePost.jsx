...
export default function CreatePost() {
    ...
    return (
        <div className='p-3 mx-auto min-h-screen w-full flex flex-col items-center '>
            <h1 className='text-center text-2xl mb-5 mt-2 sm:mt-0'>Create a Post</h1>
            ...
            <form onSubmit={handleSubmit} className='flex flex-col *:mb-5 justify-center items-center  w-full max-w-3xl p:50 input-group' >
                ...
                />
                <div className='flex flex-col items-center sm:flex-row flex-grow-1 w-full gap-5'>
