...
export default function PostPage() {
    ...
    if (isLoading) {
        ...
        return <main className=' max-w-6xl min-h-screen flex flex-col mx-auto items-center gap-10 pt-10 dark:text-gray-100 text-slate-950'>
            ...
            />
            <div dangerouslySetInnerHTML={{ __html: post.body }} className='post-content max-w-4xl text-justify text-2xl pb-15 px-5'></div>
        </main>
